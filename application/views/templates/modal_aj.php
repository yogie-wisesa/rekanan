...
<div class="modal fade" id="tambahAjModal" tabindex="-1" role="dialog" aria-labelledby="modalTambahAj" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modalTambahAj">Tambah Asuransi Jiwa</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
            </button>
        </div>
        <form method="post" action="<?= base_url('asuransi_jiwa/newAsuransi'); ?>">
