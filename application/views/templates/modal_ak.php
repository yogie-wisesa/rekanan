<!-- Modal Asuransi Kerugian -->

<!-- Modal Tambah Asuransi Kerugian -->
<div class="modal fade" id="tambahAkModal" tabindex="-1" role="dialog" aria-labelledby="modalTambahAk" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modalTambahAk">Tambah Asuransi Kerugian</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
            </button>
        </div>
        <form method="post" action="<?= base_url('asuransi_kerugian/newAsuransi'); ?>">
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama Asuransi</label>
                    <input type="text" class="form-control" id="namaAsuransi" name="namaAsuransi" placeholder="Masukkan Nama Asuransi..">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Email PIC..">
                </div>
                <div class="form-group">
                    <label>Alamat Asuransi</label>
                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan Alamat Asuransi..">
                </div>
                <div class="row justify-content-around">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Telepon</label>
                            <input type="text" class="form-control" id="contact" name="contact" placeholder="Masukkan No. Telepon..">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Scoring</label>
                            <input type="text" class="form-control" id="scoring" name="scoring" placeholder="Masukkan Angka Score..">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-around">
