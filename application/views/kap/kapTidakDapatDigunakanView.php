    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table style="font-size: 12px" class="table table-bordered" id="tabel-kap-tidakDapatDigunakan" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Instansi</th>
...
<script>
    function goView(id) {
        // alert(id);
        $('#tabel-kap-objek').DataTable().destroy();
        $('#tabel-kap-objek').DataTable({
            "bPaginate": false,
            "bFilter": false,
            "bInfo": false,
            ajax: {
                url: "<?= base_url() ?>kap/tabel_kap_objek",
                data: {
                    idKap: id
                },
                type: 'POST'
