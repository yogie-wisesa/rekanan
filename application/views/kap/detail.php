<?php
foreach ($dataKap as $dK) {
    $namaKantorKap = $dK->namaKantorKap;
}
?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h4 class="h5 mb-0" style="font-weight: bold"><?php echo $namaKantorKap ?></h4>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h7 class="m-0 font-weight-bold text-primary">Akuntan Publik Terdaftar</h7>
            ...
            <?php if ($_SESSION['role_id'] == 1) { ?>
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#tambahAkuntanModal">Akuntan Publik</a>
                    </div>
                </div>
            <?php } ?>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table style="font-size: 12px" class="table table-bordered" id="tabel-kap-akuntan" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Nama</th>
            ...
            <input type="hidden" value="<?php echo $idKap ?>" id="inputIdKap" readonly="true">
        </div>
    </div>
</div>
<!-- /.container-fluid -->
...
<script>
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
        ...
        $("#provinsi_kap").change(function() { // Ketika user mengganti atau memilih data provinsi
            $("#kota_kap").hide(); // Sembunyikan dulu combobox kota nya
