<?php
foreach ($dataBls as $dK) {
    $namaKantorBls = $dK->namaPerusahaan;
}
?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h4 class="h3 mb-0" style="font-weight: bold"><?php echo $namaKantorBls ?></h4>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Balai Lelang Swasta Terdaftar</h6>
            ...
            <?php if ($_SESSION['role_id'] == 1) { ?>
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#tambahLokasiBlsModal">Balai Lelang</a>
                    </div>
                </div>
            <?php } ?>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="tabel-bls-detail" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Pusat/Perwakilan</th>
                            <th>Provinsi</th>
                            <th>Kota</th>
                            <th>Alamat</th>
                            <th>Phone</th>
            ...
            <input type="hidden" value="<?php echo $idBls ?>" id="inputIdBls" readonly="true">
        </div>
    </div>
</div>
<!-- /.container-fluid -->
...
<script>
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
        ...
        $("#provinsi_bls").change(function() { // Ketika user mengganti atau memilih data provinsi
            $("#kota_bls").hide(); // Sembunyikan dulu combobox kota nya
            ...
            $.ajax({
                ...
                success: function(response) { // Ketika proses pengiriman berhasil
                    ...
                    $("#kota_kap").html(response.list_kota).show();
                },
