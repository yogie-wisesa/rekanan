...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Notaris Terdaftar</h6>

            <?php if ($_SESSION['role_id'] == 1) { ?>
                <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" data-toggle="modal" data-target="#tambahNotarisModal">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="tabel-notaris-kelolaan" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Notaris</th>
            ...
            <input type="hidden" value="<?php echo $idWilayah ?>" id="inputidWilayah" readonly="true">
        </div>
    </div>
</div>
<!-- /.container-fluid -->
