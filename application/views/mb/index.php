<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h4 class="h3 mb-0" style="font-weight: bold">Dashboard Money Broker</h4>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="<?= base_url('MoneyBroker/allMoneyBroker') ?>">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="<?= base_url('moneybroker/dapatDigunakan') ?>">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h7 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    foreach ($MbDiterima as $ad) {
                                        echo $ad['count(*)'] . " Money Broker";
                                    }
                                    ?>
                                </div>
                            </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="<?= base_url('MoneyBroker/terbatas') ?>">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="<?= base_url('MoneyBroker/tidakDapatDigunakan') ?>">
