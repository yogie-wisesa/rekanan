...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800" style="font-weight: bold">Upload Data Pialang Asuransi</h1>
    <div class="row">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('pialang_asuransi/uploadPs'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <p class="p mb-2 text-gray-800">ID Pialang Asuransi Terakhir:
                            <?php
                            foreach ($lastPsId as $dataId) { // Lakukan looping pada variabel siswa dari controller
                                echo "<b>" . $dataId->id . "</b>";
                            }
                            ?>
                        </p>
                        <a class="btn btn-warning btn-block btn-sm" style="width: 50%;" href="<?= base_url('downloadable/pialangSaham.csv'); ?>">Unduh Template PS </a>
